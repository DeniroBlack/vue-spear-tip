...
span(
  ...
  button(
    ...
    span.left-icon-animate(v-if="icon" :class="$slots.default ?  'left-icon' : ''")
      i.fa(:class="icon")
    slot
    span.right-icon-animate(v-if="iconRight" :class="$slots.default ?  'right-icon' : ''")
...
<script lang="ts">
import { Prop, Watch, VueClassComponent, BaseComponent } from '../../core'
 ...
 */
@VueClassComponent export default class Button extends BaseComponent {
  emits = [
    'click',
    'touchstart',
    'touchend',
